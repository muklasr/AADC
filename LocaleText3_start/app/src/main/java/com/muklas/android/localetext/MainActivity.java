...
package com.muklas.android.localetext;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String myFormattedTotal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceLocale = Locale.getDefault().getCountry();
                ...
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        if (deviceLocale.equals("FR") || deviceLocale.equals("IL")) {
                            // Use the user-chosen locale's currency format, which
                            // is either France or Israel.
                            myFormattedTotal = mCurrencyFormat.format(total);
                        } else {
                            // mPrice is the same (based on U.S. dollar).
                            // Use the currency format for the U.S.
                            mCurrencyFormat = NumberFormat.getCurrencyInstance(Locale.US);
                        ...
                        TextView localeTotal = findViewById(R.id.total);
                        localeTotal.setText(myFormattedTotal);
